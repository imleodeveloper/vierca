import { mdiCheckAll, mdiHelpCircleOutline, mdiShieldCheckOutline } from '@mdi/js';
                ...
                <section>
                    <div className="text-start">
                        ...
                        <div className="price-text">
                            ...
                            <div className="value">
                                <h3>R$ <span>91,58</span>/mês</h3>
                                <button>Outros planos</button>
                            </div>
                        </div>
                        <div className="guarantee">
                            <span><Icon path={mdiShieldCheckOutline} size={1}></Icon><p>30 dias para solicitar reembolso</p></span>
                        </div>
                    ...
                    <div className="img-start">
                        <div>
                            <Image src="/page-home.png" alt='' title='' fill style={{objectFit: 'contain'}}/>
                        </div>
                    </div>
                </section>
            </article>
